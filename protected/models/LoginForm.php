...
class LoginForm extends CFormModel
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'username' => Yii::t('pages', 'loginForm.username'),
			'password' => Yii::t('pages', 'loginForm.password')
		);
	}

	// some validation against SQL injection
	public function loginformValidate()
	{
		$fail = false;

		if (!preg_match("/^[a-z][a-z]{2,9}[0-9]{0,3}$/", $this->username)) {
